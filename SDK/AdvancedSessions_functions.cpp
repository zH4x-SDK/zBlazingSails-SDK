...
void UAdvancedExternalUILibrary::STATIC_ShowWebURLUI(const struct FString& URLToShow, bool bEmbedded, bool bShowBackground, bool bShowCloseButton, int OffsetX, int OffsetY, int SizeX, int SizeY, EBlueprintResultSwitch* Result, TArray<struct FString>* AllowedDomains)
{
...
void UAdvancedExternalUILibrary::STATIC_ShowProfileUI(const struct FBPUniqueNetId& PlayerViewingProfile, const struct FBPUniqueNetId& PlayerToViewProfileOf, EBlueprintResultSwitch* Result)
{
...
void UAdvancedExternalUILibrary::STATIC_ShowLeaderBoardUI(const struct FString& LeaderboardName, EBlueprintResultSwitch* Result)
{
...
void UAdvancedExternalUILibrary::STATIC_ShowAccountUpgradeUI(const struct FBPUniqueNetId& PlayerRequestingAccountUpgradeUI, EBlueprintResultSwitch* Result)
{
...
void UAdvancedFriendsLibrary::STATIC_SendSessionInviteToFriend(class APlayerController* PlayerController, const struct FBPUniqueNetId& FriendUniqueNetId, EBlueprintResultSwitch* Result)
{
...
void UAdvancedIdentityLibrary::STATIC_SetUserAccountAttribute(const struct FBPUserOnlineAccount& AccountInfo, const struct FString& AttributeName, const struct FString& NewAttributeValue, EBlueprintResultSwitch* Result)
{
...
void UAdvancedIdentityLibrary::STATIC_GetUserAccountAuthAttribute(const struct FBPUserOnlineAccount& AccountInfo, const struct FString& AttributeName, struct FString* AuthAttribute, EBlueprintResultSwitch* Result)
{
...
void UAdvancedIdentityLibrary::STATIC_GetUserAccountAttribute(const struct FBPUserOnlineAccount& AccountInfo, const struct FString& AttributeName, struct FString* AttributeValue, EBlueprintResultSwitch* Result)
{
...
void UAdvancedIdentityLibrary::STATIC_GetUserAccount(const struct FBPUniqueNetId& UniqueNetId, struct FBPUserOnlineAccount* AccountInfo, EBlueprintResultSwitch* Result)
{
...
void UAdvancedIdentityLibrary::STATIC_GetLoginStatus(const struct FBPUniqueNetId& UniqueNetId, EBPLoginStatus* LoginStatus, EBlueprintResultSwitch* Result)
{
...
void UAdvancedSessionsLibrary::STATIC_GetSessionPropertyString(TArray<struct FSessionPropertyKeyPair> ExtraSettings, const struct FName& SettingName, ESessionSettingSearchResult* SearchResult, struct FString* SettingValue)
{
...
void UAdvancedSessionsLibrary::STATIC_GetSessionPropertyInt(TArray<struct FSessionPropertyKeyPair> ExtraSettings, const struct FName& SettingName, ESessionSettingSearchResult* SearchResult, int* SettingValue)
{
...
void UAdvancedSessionsLibrary::STATIC_GetSessionPropertyFloat(TArray<struct FSessionPropertyKeyPair> ExtraSettings, const struct FName& SettingName, ESessionSettingSearchResult* SearchResult, float* SettingValue)
{
...
void UAdvancedSessionsLibrary::STATIC_GetSessionPropertyByte(TArray<struct FSessionPropertyKeyPair> ExtraSettings, const struct FName& SettingName, ESessionSettingSearchResult* SearchResult, unsigned char* SettingValue)
{
...
void UAdvancedSessionsLibrary::STATIC_GetSessionPropertyBool(TArray<struct FSessionPropertyKeyPair> ExtraSettings, const struct FName& SettingName, ESessionSettingSearchResult* SearchResult, bool* SettingValue)
{
...
void UAdvancedSessionsLibrary::STATIC_FindSessionPropertyIndexByName(TArray<struct FSessionPropertyKeyPair> ExtraSettings, const struct FName& SettingName, EBlueprintResultSwitch* Result, int* OutIndex)
{
...
void UAdvancedSessionsLibrary::STATIC_FindSessionPropertyByName(TArray<struct FSessionPropertyKeyPair> ExtraSettings, const struct FName& SettingsName, EBlueprintResultSwitch* Result, struct FSessionPropertyKeyPair* OutProperty)
{
...
// Function AdvancedSessions.CreateSessionCallbackProxyAdvanced.CreateAdvancedDedicatedSession
// (Final, Native, Static, Public, HasOutParms, BlueprintCallable)
// Parameters:
// class UObject*                 WorldContextObject             (Parm, ZeroConstructor, IsPlainOldData)
// TArray<struct FSessionPropertyKeyPair> ExtraSettings                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
class UCreateSessionCallbackProxyAdvanced* UCreateSessionCallbackProxyAdvanced::STATIC_CreateAdvancedDedicatedSession(class UObject* WorldContextObject, TArray<struct FSessionPropertyKeyPair> ExtraSettings, int PublicConnections, int PrivateConnections, bool bUseLAN, bool bAllowInvites, bool bAntiCheatProtected, bool bUsesStats, bool bShouldAdvertise)
{
	static auto fn = UObject::FindObject<UFunction>("Function AdvancedSessions.CreateSessionCallbackProxyAdvanced.CreateAdvancedDedicatedSession");

	UCreateSessionCallbackProxyAdvanced_CreateAdvancedDedicatedSession_Params params;
	params.WorldContextObject = WorldContextObject;
	params.ExtraSettings = ExtraSettings;
	params.PublicConnections = PublicConnections;
	params.PrivateConnections = PrivateConnections;
...
class UGetUserPrivilegeCallbackProxy* UGetUserPrivilegeCallbackProxy::STATIC_GetUserPrivilege(class UObject* WorldContextObject, EBPUserPrivileges PrivilegeToCheck, const struct FBPUniqueNetId& PlayerUniqueNetID)
{
