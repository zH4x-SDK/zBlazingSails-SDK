...
bool UAdvancedSteamFriendsLibrary::STATIC_OpenSteamUserOverlay(const struct FBPUniqueNetId& UniqueNetId, ESteamUserOverlayType DialogType)
{
...
void UAdvancedSteamFriendsLibrary::STATIC_GetSteamFriendGamePlayed(const struct FBPUniqueNetId& UniqueNetId, EBlueprintResultSwitch* Result, int* AppId)
{
