...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BowBarrelMount.BP_BowBarrelMount_C.ReceiveBeginPlay");

	ABP_BowBarrelMount_C_ReceiveBeginPlay_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BowBarrelMount.BP_BowBarrelMount_C.ReceiveTick");

	ABP_BowBarrelMount_C_ReceiveTick_Params params;
