...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ContainerBase.BP_ContainerBase_C.OnRep_FloatingMode");

	ABP_ContainerBase_C_OnRep_FloatingMode_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ContainerBase.BP_ContainerBase_C.EventFloatingRep");

	ABP_ContainerBase_C_EventFloatingRep_Params params;
