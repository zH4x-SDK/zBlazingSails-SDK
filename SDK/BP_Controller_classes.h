...
public:
	...
	unsigned char                                      UnknownData10[0x7];                                       // 0x0911(0x0007) MISSED OFFSET
	class UUI_Broadcast_C*                             BroadcastRef;                                             // 0x0918(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	...
	void S_LoadShipCustomisation(int HullColor, int SailColor, int emblem, int bowfigure, int FlagColor, int RopeColor, int FlagEmblem, int LampColor, int SailEmblemBottom, int SailColorBottom, int ShipPaint);
	...
	void ExplodeBowBarrel(class ABP_BowBarrel_C* BowBarrel);
	void S_ExplodeBowBarrel(class ABP_BowBarrel_C* BowBarrel);
