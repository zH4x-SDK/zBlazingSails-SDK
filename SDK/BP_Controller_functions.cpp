...
// int                            ShipPaint                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Controller_C::S_LoadShipCustomisation(int HullColor, int SailColor, int emblem, int bowfigure, int FlagColor, int RopeColor, int FlagEmblem, int LampColor, int SailEmblemBottom, int SailColorBottom, int ShipPaint)
{
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class ABP_BowBarrel_C*         BowBarrel                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Controller_C::ExplodeBowBarrel(class ABP_BowBarrel_C* BowBarrel)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.ExplodeBowBarrel");

	ABP_Controller_C_ExplodeBowBarrel_Params params;
	params.BowBarrel = BowBarrel;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.S_ExplodeBowBarrel");

	ABP_Controller_C_S_ExplodeBowBarrel_Params params;
	params.BowBarrel = BowBarrel;
...
// Function BP_Controller.BP_Controller_C.S_SetLevel
// (Net, NetReliable, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
// int                            Level                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Controller_C::S_SetLevel(int Level)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.S_SetLevel");

	ABP_Controller_C_S_SetLevel_Params params;
	params.Level = Level;
...
void ABP_Controller_C::CreateAndAddWaterCullingVolume(class ABP_BoatMeshBase_C* BoatMeshBaseRef)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.CreateAndAddWaterCullingVolume");

	ABP_Controller_C_CreateAndAddWaterCullingVolume_Params params;
	params.BoatMeshBaseRef = BoatMeshBaseRef;
