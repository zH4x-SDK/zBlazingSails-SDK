...
void ABP_CrewBanner_C::GetClosestWindActor()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_CrewBanner.BP_CrewBanner_C.GetClosestWindActor");

	ABP_CrewBanner_C_GetClosestWindActor_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_CrewBanner.BP_CrewBanner_C.ReceiveTick");

	ABP_CrewBanner_C_ReceiveTick_Params params;
