...
public:
	...
	struct FST_Customisation                           Customization;                                            // 0x0408(0x0070) (Edit, BlueprintVisible, Net, DisableEditOnInstance)
	class ABP_Mannequin_C*                             Mannequin;                                                // 0x0478(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	int                                                TeamID;                                                   // 0x0480(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0484(0x0004) MISSED OFFSET
	struct FST_Customisation                           LeaderCustomization;                                      // 0x0488(0x0070) (Edit, BlueprintVisible, Net, DisableEditOnInstance)
