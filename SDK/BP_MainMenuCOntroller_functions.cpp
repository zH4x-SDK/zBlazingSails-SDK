...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenuCOntroller.BP_MainMenuCOntroller_C.CreateAndAddWaterCullingVolume");

	ABP_MainMenuCOntroller_C_CreateAndAddWaterCullingVolume_Params params;
