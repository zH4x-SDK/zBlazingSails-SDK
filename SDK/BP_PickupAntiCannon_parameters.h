...
struct ABP_PickupAntiCannon_C_UserConstructionScript_Params
{
};

// Function BP_PickupAntiCannon.BP_PickupAntiCannon_C.ReceiveBeginPlay
struct ABP_PickupAntiCannon_C_ReceiveBeginPlay_Params
{
};

// Function BP_PickupAntiCannon.BP_PickupAntiCannon_C.S_Activate
struct ABP_PickupAntiCannon_C_S_Activate_Params
{
};
