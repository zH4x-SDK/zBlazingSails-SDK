...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PickupWeaponDoubleBarrel.BP_PickupWeaponDoubleBarrel_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PickupWeaponDoubleBarrel(int EntryPoint);
};
