...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_QuickAccesPointBase.BP_QuickAccesPointBase_C.OnRep_Amount");

	ABP_QuickAccesPointBase_C_OnRep_Amount_Params params;
...
// Parameters:
// TEnumAsByte<E_Items>           Resource                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            Amount                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_QuickAccesPointBase_C::GiveResource(TEnumAsByte<E_Items> Resource, int Amount)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_QuickAccesPointBase.BP_QuickAccesPointBase_C.GiveResource");

	ABP_QuickAccesPointBase_C_GiveResource_Params params;
...
void ABP_QuickAccesPointBase_C::ShowReceivedIndicator(int Amount, TEnumAsByte<E_Items> Resource)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_QuickAccesPointBase.BP_QuickAccesPointBase_C.ShowReceivedIndicator");

	ABP_QuickAccesPointBase_C_ShowReceivedIndicator_Params params;
	params.Amount = Amount;
	params.Resource = Resource;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_QuickAccesPointBase.BP_QuickAccesPointBase_C.AmountRepEvent");

	ABP_QuickAccesPointBase_C_AmountRepEvent_Params params;
