...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_QuickAccesPoint_HeavyCannonballs.BP_QuickAccesPoint_HeavyCannonballs_C");
		return ptr;
	}
	...
	void GiveResources();
	void AmountRepEvent();
	void ExecuteUbergraph_BP_QuickAccesPoint_HeavyCannonballs(int EntryPoint);
};
