...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_QuickAccesPoint_NormalCannonballs.BP_QuickAccesPoint_NormalCannonballs_C");
		return ptr;
	}
	...
	void GiveResources();
	void AmountRepEvent();
	void ExecuteUbergraph_BP_QuickAccesPoint_NormalCannonballs(int EntryPoint);
};
