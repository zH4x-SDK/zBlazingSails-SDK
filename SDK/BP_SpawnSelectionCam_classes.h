...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_SpawnSelectionCam.BP_SpawnSelectionCam_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_SpawnSelectionCam(int EntryPoint);
};
