...
public:
	...
	struct FST_Customisation                           Customization;                                            // 0x0348(0x0070) (Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                               bIsValid;                                                 // 0x03B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x03B9(0x0007) MISSED OFFSET
	class UUI_CrewMemberInfo_C*                        MemberInfoWidgetRef;                                      // 0x03C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	class ASteamBeaconPlayerState*                     BeaconPlayerState;                                        // 0x03C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	class ABP_UI_CrewLobbyManager_C*                   CrewManager;                                              // 0x03D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
