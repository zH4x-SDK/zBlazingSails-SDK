...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UParticleSystem*         Muzzle_TP                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UParticleSystem*         Smoke_TP                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UParticleSystem*         Muzzle_FP                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UParticleSystem*         Smoke_FP                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// float                          ClunkSoundPitch                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UParticleSystem*         Fuse                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FVector                 AttachToCannonScale            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FVector                 DettachToCannonScale           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_VehicleCannon_C::Muzzle(class UParticleSystem* Muzzle_TP, class UParticleSystem* Smoke_TP, class UParticleSystem* Muzzle_FP, class UParticleSystem* Smoke_FP, float ClunkSoundPitch, class UParticleSystem* Fuse, const struct FVector& AttachToCannonScale, const struct FVector& DettachToCannonScale)
{
	...
	params.Muzzle_TP = Muzzle_TP;
	params.Smoke_TP = Smoke_TP;
	params.Muzzle_FP = Muzzle_FP;
	params.Smoke_FP = Smoke_FP;
	params.ClunkSoundPitch = ClunkSoundPitch;
	params.Fuse = Fuse;
	params.AttachToCannonScale = AttachToCannonScale;
	params.DettachToCannonScale = DettachToCannonScale;
