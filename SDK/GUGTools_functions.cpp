...
unsigned char UGenericBFL::STATIC_GUG_GetDayOfWeek(const struct FDateTime& InDateTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function GUGTools.GenericBFL.GUG_GetDayOfWeek");

	UGenericBFL_GUG_GetDayOfWeek_Params params;
