...
{
	static auto fn = UObject::FindObject<UFunction>("Function KinematicPawnMovement.KinematicPawnMovement_C.MC_JumpLaunch");

	UKinematicPawnMovement_C_MC_JumpLaunch_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function KinematicPawnMovement.KinematicPawnMovement_C.S_InAirStateUpdate");

	UKinematicPawnMovement_C_S_InAirStateUpdate_Params params;
	params.inAir = inAir;
