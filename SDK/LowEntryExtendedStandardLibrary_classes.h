...
{
public:
	unsigned char                                      Type;                                                     // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      ByteValue;                                                // 0x0029(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x002A(0x0002) MISSED OFFSET
	int                                                IntegerValue;                                             // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULowEntryLong*                               LongBytesValue;                                           // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              FloatValue;                                               // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x003C(0x0004) MISSED OFFSET
	class ULowEntryDouble*                             DoubleBytesValue;                                         // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               BooleanValue;                                             // 0x0048(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0049(0x0007) MISSED OFFSET
	struct FString                                     StringUtf8Value;                                          // 0x0050(0x0010) (ZeroConstructor)
	TArray<unsigned char>                              ByteArrayValue;                                           // 0x0060(0x0010) (ZeroConstructor)
	TArray<int>                                        IntegerArrayValue;                                        // 0x0070(0x0010) (ZeroConstructor)
	TArray<class ULowEntryLong*>                       LongBytesArrayValue;                                      // 0x0080(0x0010) (ZeroConstructor)
	TArray<float>                                      FloatArrayValue;                                          // 0x0090(0x0010) (ZeroConstructor)
	TArray<class ULowEntryDouble*>                     DoubleBytesArrayValue;                                    // 0x00A0(0x0010) (ZeroConstructor)
	TArray<bool>                                       BooleanArrayValue;                                        // 0x00B0(0x0010) (ZeroConstructor)
	TArray<struct FString>                             StringUtf8ArrayValue;                                     // 0x00C0(0x0010) (ZeroConstructor)
...
{
public:
	TArray<unsigned char>                              Bytes;                                                    // 0x0028(0x0010) (ZeroConstructor)
	int                                                Position;                                                 // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      CurrentByte;                                              // 0x003C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x003D(0x0003) MISSED OFFSET
	int                                                CurrentBytePosition;                                      // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	TArray<unsigned char>                              Bytes;                                                    // 0x0028(0x0010) (ZeroConstructor)
	unsigned char                                      CurrentByte;                                              // 0x0038(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0039(0x0003) MISSED OFFSET
	int                                                CurrentBytePosition;                                      // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<unsigned char>                              ByteArray;                                                // 0x0028(0x0010) (ZeroConstructor)
...
public:
	...
	bool                                               Next;                                                     // 0x002C(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	void STATIC_TextureRenderTarget2DToBytes(class UTextureRenderTarget2D* TextureRenderTarget2D, ELowEntryImageFormat ImageFormat, int CompressionQuality, TArray<unsigned char>* ByteArray);
	void STATIC_Texture2DToPixels(class UTexture2D* Texture2D, int* Width, int* Height, TArray<struct FColor>* Pixels);
	void STATIC_Texture2DToBytes(class UTexture2D* Texture2D, ELowEntryImageFormat ImageFormat, int CompressionQuality, TArray<unsigned char>* ByteArray);
	...
	void STATIC_SortTimespanArrayDirectly(bool Reversed, TArray<struct FTimespan>* TimespanArray);
	TArray<struct FTimespan> STATIC_SortTimespanArray(TArray<struct FTimespan> TimespanArray, bool Reversed);
	void STATIC_SortStringArrayDirectly(bool Reversed, TArray<struct FString>* StringArray);
	TArray<struct FString> STATIC_SortStringArray(TArray<struct FString> StringArray, bool Reversed);
	void STATIC_SortObjectArrayDirectly(const struct FScriptDelegate& Comparator, bool Reversed, TArray<class UObject*>* ObjectArray);
	...
	void STATIC_SortIntegerArrayDirectly(bool Reversed, TArray<int>* IntegerArray);
	TArray<int> STATIC_SortIntegerArray(TArray<int> IntegerArray, bool Reversed);
	void STATIC_SortFloatArrayDirectly(bool Reversed, TArray<float>* FloatArray);
	TArray<float> STATIC_SortFloatArray(TArray<float> FloatArray, bool Reversed);
	void STATIC_SortDateTimeArrayDirectly(bool Reversed, TArray<struct FDateTime>* DateTimeArray);
	TArray<struct FDateTime> STATIC_SortDateTimeArray(TArray<struct FDateTime> DateTimeArray, bool Reversed);
	void STATIC_SortByteArrayDirectly(bool Reversed, TArray<unsigned char>* ByteArray);
	...
	void STATIC_SetSplitScreenType_TwoPlayers(ELowEntrySplitScreenTypeTwoPlayers Type);
	void STATIC_SetSplitScreenType_ThreePlayers(ELowEntrySplitScreenTypeThreePlayers Type);
	...
	void STATIC_SceneCaptureComponent2DToBytes(class USceneCaptureComponent2D* SceneCaptureComponent2D, ELowEntryImageFormat ImageFormat, int CompressionQuality, TArray<unsigned char>* ByteArray);
	...
	void STATIC_SceneCapture2DToBytes(class ASceneCapture2D* SceneCapture2D, ELowEntryImageFormat ImageFormat, int CompressionQuality, TArray<unsigned char>* ByteArray);
	...
	void STATIC_QueueExecutions(class UObject* WorldContextObject, const struct FLatentActionInfo& LatentInfo, class ULowEntryExecutionQueue** Queue);
	...
	class UTexture2D* STATIC_PixelsToExistingTexture2D(class UTexture2D* Texture2D, int Width, int Height, TArray<struct FColor> Pixels, bool* ReusedGivenTexture2D);
	void STATIC_PixelsToBytes(int Width, int Height, TArray<struct FColor> Pixels, ELowEntryImageFormat ImageFormat, int CompressionQuality, TArray<unsigned char>* ByteArray);
	...
	void STATIC_LoadVideo(class UMediaSoundComponent* MediaSoundComponent, const struct FString& URL, bool PlayOnOpen, bool Loop, bool* Success, class UMediaPlayer** MediaPlayer, class UMediaTexture** MediaTexture);
	...
	TArray<unsigned char> STATIC_HMAC(TArray<unsigned char> ByteArray, TArray<unsigned char> Key, ELowEntryHmacAlgorithm Algorithm, int Index, int Length);
	...
	void STATIC_GetSplitScreenType(ELowEntrySplitScreenType* Type);
	...
	void STATIC_GetBatteryState(ELowEntryBatteryState* State, bool* Success);
	...
	void STATIC_ExecToInteger(ELowEntryExtendedStandardLibrary0to9 Branch, int* Value);
	void STATIC_ExecToByte(ELowEntryExtendedStandardLibrary0to9 Branch, unsigned char* Value);
	void STATIC_ExecToBoolean(ELowEntryExtendedStandardLibraryTrueOrFalse Branch, bool* Value);
	...
	void STATIC_DateTime_ToString(const struct FDateTime& DateTime, const struct FString& Format, struct FString* String);
	...
	void STATIC_CaseSwitchObject(int OnlyCheckFirstX, class UObject* Value, class UObject* _1__, class UObject* _2__, class UObject* _3__, class UObject* _4__, class UObject* _5__, class UObject* _6__, class UObject* _7__, class UObject* _8__, class UObject* _9__, class UObject* _10__, ELowEntryExtendedStandardLibrary1to10other* Branch);
	void STATIC_CaseSwitchInteger(int OnlyCheckFirstX, int Value, int _1__, int _2__, int _3__, int _4__, int _5__, int _6__, int _7__, int _8__, int _9__, int _10__, ELowEntryExtendedStandardLibrary1to10other* Branch);
	void STATIC_CaseSwitchByte(int OnlyCheckFirstX, unsigned char Value, unsigned char _1__, unsigned char _2__, unsigned char _3__, unsigned char _4__, unsigned char _5__, unsigned char _6__, unsigned char _7__, unsigned char _8__, unsigned char _9__, unsigned char _10__, ELowEntryExtendedStandardLibrary1to10other* Branch);
	...
	void STATIC_BytesToPixels(TArray<unsigned char> ByteArray, ELowEntryImageFormat ImageFormat, int Index, int Length, int* Width, int* Height, TArray<struct FColor>* Pixels);
	...
	class UTexture2D* STATIC_BytesToImage(TArray<unsigned char> ByteArray, ELowEntryImageFormat ImageFormat, int Index, int Length);
	...
	class UTexture2D* STATIC_BytesToExistingImage(class UTexture2D* Texture2D, TArray<unsigned char> ByteArray, ELowEntryImageFormat ImageFormat, int Index, int Length, bool* ReusedGivenTexture2D);
...
{
public:
	bool                                               Finished;                                                 // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               Result;                                                   // 0x0029(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x002A(0x0002) MISSED OFFSET
	int                                                KeepAliveCount;                                           // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	int                                                KeepAliveCount;                                           // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	bool                                               Finished;                                                 // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0029(0x0003) MISSED OFFSET
	int                                                Result;                                                   // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                KeepAliveCount;                                           // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
...
public:
	...
	class UObject*                                     Result;                                                   // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                KeepAliveCount;                                           // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x003C(0x0004) MISSED OFFSET
...
public:
	bool                                               Finished;                                                 // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0029(0x0007) MISSED OFFSET
	struct FString                                     Result;                                                   // 0x0030(0x0010) (ZeroConstructor)
	int                                                KeepAliveCount;                                           // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
...
{
public:
	bool                                               Valid;                                                    // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0029(0x0007) MISSED OFFSET
	struct FString                                     Resource;                                                 // 0x0030(0x0010) (ZeroConstructor)
	struct FDateTime                                   Date;                                                     // 0x0040(0x0008) (ZeroConstructor)
	int                                                Bits;                                                     // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
