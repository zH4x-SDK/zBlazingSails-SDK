...
struct UUI_Block_C_SetOpacityAndColor_Params
{
	struct FLinearColor                                ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function UI_Block.UI_Block_C.ShowBlock
struct UUI_Block_C_ShowBlock_Params
{
	ESlateVisibility                                   ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function UI_Block.UI_Block_C.Construct
struct UUI_Block_C_Construct_Params
{
};

// Function UI_Block.UI_Block_C.Tick
struct UUI_Block_C_Tick_Params
{
...
struct UUI_Block_C_ExecuteUbergraph_UI_Block_Params
{
