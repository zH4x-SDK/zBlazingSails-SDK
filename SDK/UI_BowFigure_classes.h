...
// WidgetBlueprintGeneratedClass UI_BowFigure.UI_BowFigure_C
// 0x0040 (0x0248 - 0x0208)
class UUI_BowFigure_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_BowFigure.UI_BowFigure_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_BowFigure(int EntryPoint);
};
