...
// WidgetBlueprintGeneratedClass UI_Emblem.UI_Emblem_C
// 0x0041 (0x0249 - 0x0208)
class UUI_Emblem_C : public UUserWidget
{
public:
	...
	bool                                               TopSail;                                                  // 0x0248(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Emblem.UI_Emblem_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_Emblem(int EntryPoint);
};
