...
struct UUI_GameplayOptions_C_Construct_Params
{
};
...
struct UUI_GameplayOptions_C_BndEvt__Dropdown_CameraPosition_K2Node_ComponentBoundEvent_175_OnSelectionChangedEvent__DelegateSignature_Params
{
...
struct UUI_GameplayOptions_C_BndEvt__Dropdown_Perspective_K2Node_ComponentBoundEvent_43_OnSelectionChangedEvent__DelegateSignature_Params
{
	struct FString                                     SelectedItem;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
	TEnumAsByte<ESelectInfo>                           SelectionType;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UUI_GameplayOptions_C_BndEvt__CheckBox_0_K2Node_ComponentBoundEvent_1_OnCheckBoxComponentStateChanged__DelegateSignature_Params
{
	bool                                               bIsChecked;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
