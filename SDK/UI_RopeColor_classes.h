...
// WidgetBlueprintGeneratedClass UI_RopeColor.UI_RopeColor_C
// 0x0040 (0x0248 - 0x0208)
class UUI_RopeColor_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_RopeColor.UI_RopeColor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_RopeColor(int EntryPoint);
};
