...
class UUI_TreasureChestMarker_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_TreasureChestMarker.UI_TreasureChestMarker_C");
		return ptr;
	}


	ESlateVisibility SetShowWidget();
};
